...
<head>
    ...
    <title>Iklan Bermasalah - Everpro</title>
    <!-- Bootstrap CSS CDN -->
                ...
                <li class="nav-item">
                    <details open>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item"><a class="nav-link text-muted" href="{{ route('ads.balance') }}"><i class="fas fa-wallet me-2"></i>Saldo Iklan</a></li>
                            <li class="nav-item"><a class="nav-link active" href="#"><i class="fas fa-exclamation-triangle me-2"></i>Iklan Bermasalah</a></li>
                        </ul>
                    </details>
                </li>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card p-4 shadow-sm mb-4">
                    <h3 class="fw-bold mb-4">Iklan Bermasalah</h3>
                    
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="#">Semua Status</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Tinjau Ulang</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Menunggu</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">Selesai</a></li>
                        </ul>
                        <a href="#" class="btn btn-outline-primary btn-sm"><i class="fas fa-download me-2"></i>Unduh Laporan</a>
                    </div>

                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Cari ID Iklan, nama kampanye, ID Akun">
                        <select class="form-select" style="width: 200px;">
                            <option selected>Semua Akun Iklan</option>
                        ...
                        <button class="btn btn-outline-secondary" type="button"><i class="fas fa-filter me-2"></i>Filter</button>
                    </div>
